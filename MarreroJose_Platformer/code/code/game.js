...
function Player(pos) {
  this.pos = pos.plus(new Vector(0, -1.15));
  this.size = new Vector(1, 2.3);
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  if (keys.left){
    ...
    //document.getElementsByClassName("player").style.transform = "scaleX(-1)";
...
if (!this.actors.some(function(actor) {
          //document.getElementsByClassName("actor key").style.backgroundImage = 'url("assets/teleporter.png")';
